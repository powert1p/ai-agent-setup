...
ВСЁ кроме приветствий. Глагол ("сделай", "почитай") = задача. Вопрос ("почему?", "как?", "что если?") = тоже задача.
Если сомневаешься — это задача. "Обсуждение" = ТОЛЬКО "привет", "как дела", чистый smalltalk.
