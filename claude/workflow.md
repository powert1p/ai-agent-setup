...
| Обсуждение | ТОЛЬКО приветствие/smalltalk без глагола действия | Ответь на языке продукта |

**Что считается задачей (= brainstorming обязателен):**
Любое сообщение с глаголом действия: "почитай", "разберись", "сделай", "добавь", "поправь", "настрой", "изучи", "проверь".
Если сомневаешься — это задача. "Обсуждение" = ТОЛЬКО "привет", "как дела", smalltalk без запроса на действие.
